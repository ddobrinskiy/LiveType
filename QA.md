...
showed green checkmarks for all PASS rows and the extension preview in Ready
state. The progress viewer was separately rendered in headless Chromium: its
